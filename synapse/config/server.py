...
# PG_CHANGED: removed "manhole" from known listener types
...
class ServerConfig(Config):
    ...
    def read_config(self, config: JsonDict, **kwargs: Any) -> None:
        ...
        # PG_CHANGED: manhole force-disabled
        manhole = config.get("manhole")
        if manhole:
            raise ConfigError(
                "The manhole listener has been disabled in this build of Synapse. "
                "Remove the 'manhole' option from your configuration."
            )
    ...
    def read_arguments(self, args: argparse.Namespace) -> None:
        ...
        if args.manhole is not None:
            raise ConfigError(
                "The manhole listener has been disabled in this build of Synapse. "
                "Do not use the --manhole argument."
            )
