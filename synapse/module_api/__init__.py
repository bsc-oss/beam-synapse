...
class ModuleApi:
    ...
    def register_third_party_rules_callbacks(
        ...
        *,
        ...
        | None = None,
        # PG_CHANGED
        on_enrich_membership_content: ON_ENRICH_MEMBERSHIP_CONTENT_CALLBACK | None = None,
        # PG_CHANGED
        ...
        return self._callbacks.third_party_event_rules.register_third_party_rules_callbacks(
            ...
            # PG_CHANGED
            on_enrich_membership_content=on_enrich_membership_content,
            # PG_CHANGED
