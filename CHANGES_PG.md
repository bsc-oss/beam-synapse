# Changes in PG Synapse 1.150.3+pg.3

Bugfix 🐛:

- Use version pg-synapse-module==0.1.10 which fixes logContext leaks

# Changes in PG Synapse 1.150.3+pg.1

Upstream merge ✨:

- Upstream merge of version v1.153.0 (https://github.com/element-hq/synapse/tree/v1.153.0)

# Changes in PG Synapse 1.150.0+pg.1

Upstream merge ✨:

- Upstream merge of version v1.150.0 (https://github.com/element-hq/synapse/tree/v1.150.0)

# Changes in PG Synapse 1.147.1+pg.3

Features ✨:
- Add new callback ON_LEAVE_ROOM_CALLBACK
- Upgrade to verion 0.1.9 of the pg-synapse which includes m.room.member event redaction
